...
class MyPostTableViewController: UITableViewController {
    var data = [User]()
           ...
           override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
               let cell:MyPostViewCell = tableView.dequeueReusableCell(withIdentifier: "MyPostViewCell", for: indexPath) as! MyPostViewCell
            ...
            cell.imageview.image = UIImage(named: "avatar")
               if st.avatar != ""{
                cell.imageview.kf.setImage(with: URL(string: st.avatar));
               }
